...
%\definecolor{myblue}{RGB}{255,148,238} % test 
...
\author{郭宇杰\inst{$\dagger$}, Yu-Chieh Kuo\inst{2}} 
\date{\today} 

\institute%[NTU] % Not sure the function of options setting
{
    \inst{1}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Set frame numbering and hide subsections in toc before entering a new section
...
%includeonlyframes{current} % Only compile frames with the current label to save time
\begin{document}
...
% Enter the outline page after elaborating on the motivation
\begin{frame}
    \frametitle{Outline}
    \tableofcontents
\end{frame} 
